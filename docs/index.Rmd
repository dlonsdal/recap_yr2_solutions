...
A reminder that when you start to use <TT>R</TT>, you will often need to import data to analyse. For this session, we are going to use some pharmacokinetic data that can be downloaded from Canvas - 'amoxicillin.csv'. 
